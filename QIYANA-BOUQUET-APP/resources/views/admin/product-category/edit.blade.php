        ...
        <div class="w-full grid grid-cols-1 xl:grid-cols-3 gap-5 lg:gap-10">
            ...
            <div class="w-full xl:col-span-2 bg-white rounded-lg p-5 py-10 lg:px-10">
                <div class="w-full flex justify-between items-center">
                    <h1 class="flex text-2xl font-bold leading-normal xl:leading-relaxed">Ubah Kategori Produk</h1>
                </div>
                {{-- MAIN TABLE --}}
                <form action="{{ route('kategori-produk.update', $productCategory->id) }}" method="POST" class="w-full">
                    @csrf
                    @method('PATCH')
                    <div class="w-full py-10 space-y-3">
                        ...
                        <div id="input-group">
                            ...
                            <div class="relative">
                                ...
                                <x-text-input id="category_name" class="w-full placeholder-gray-400 pl-12 pr-4 py-3" type="text" name="category_name" :value="old('category_name') ?? $productCategory->name" placeholder="Masukkan nama kategori produk"  />
                            </div>
                    ...
                    <div class="w-full flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-3 md:justify-end">
                        ...
                        <x-primary-button type="submit" class="w-full md:w-40">Update Data</x-primary-button>
                    </div>
                </form>
            </div>
            {{-- RIGHT --}}
