...
@section('title', 'Tambah Slide Homepage')
        ...
        <div class="w-full grid grid-cols-1 xl:grid-cols-3 gap-5 lg:gap-10">
            ...
            <div class="w-full xl:col-span-2 bg-white rounded-lg p-5 py-10 lg:px-10">
                <div class="w-full flex justify-between items-center">
                    <h1 class="text-2xl font-bold">Tambah Slide Baru</h1>
                </div>

                <form action="{{ route('slider-homepage.store') }}" method="POST" enctype="multipart/form-data" class="w-full">
                    @csrf
                    <div class="w-full py-10 space-y-5">
                        {{-- Title --}}
                        <div>
                            <x-input-label for="judul_slide" :value="__('Judul Slide')" />
                            <x-text-input id="judul_slide" name="judul_slide" type="text" class="w-full mt-1" :value="old('judul_slide')" placeholder="Masukkan judul slide" />
                        ...
                        <div>
                            ...
                            <x-text-input id="subjudul_slide" name="subjudul_slide" type="text" class="w-full mt-1" :value="old('subjudul_slide')" placeholder="Masukkan subjudul slide" />
                            <x-input-error :messages="$errors->get('subjudul_slide')" class="mt-2" />
                        </div>

                        {{-- Image --}}
                        <div>
                            <x-input-label for="image" :value="__('Gambar Slide')" />
                        ...
                        <div>
                            ...
                            <x-text-input id="link" name="link" type="text" class="w-full mt-1" :value="old('link')" placeholder="Masukkan URL/link tujuan" />
                        ...
                        <div>
                            ...
                            <x-text-input id="link_text" name="link_text" type="text" class="w-full mt-1" :value="old('link_text')" placeholder="Masukkan teks tombol/link" />
                        ...
                        <div>
                            ...
                            <textarea id="deskripsi" name="deskripsi" rows="4" class="w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('deskripsi') }}</textarea>
                    ...
                    <div class="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-3 md:justify-end">
                        ...
                        <x-primary-button type="submit" class="w-full md:w-40">Simpan Slide</x-primary-button>
                    </div>
                </form>
            </div>
            ...
            <div class="w-full flex flex-col space-y-5 lg:space-y-10">
                <div class="w-full flex items-center space-x-2 lg:space-x-5 bg-white rounded-lg p-5 lg:p-8">
                    ...
                    <div class="w-full">
                        <h1 class="text-xl md:text-2xl lg:text-3xl font-bold">{{ $sliderHomepageCount ?? '0' }}</h1>
