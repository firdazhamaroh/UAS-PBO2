            ...
            <div class="w-full grid grid-cols-1 xl:grid-cols-3 gap-5 lg:gap-10">
                ...
                <div class="w-full xl:col-span-2 bg-white rounded-lg p-5 py-10 lg:px-10">
                    <div class="w-full flex justify-between items-center">
                        <h1 class="flex text-2xl font-bold leading-normal xl:leading-relaxed">Produk</h1>
                        <a href="{{ route('produk.create') }}">
                            <x-primary-button type="submit" class="w-40">Tambah Produk</x-primary-button>
                        </a>
                    </div>
                    {{-- MAIN TABLE --}}
                    <table id="produk-datatable" class="w-full">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama Produk</th>
...
@push('script')
    ...
    <script>
        $(function () {
            let PRODUK_DATATABLE = $('#produk-datatable').DataTable({
                processing: true,
                responsive: true,
                serverSide: true,
                autoWidth: false,
